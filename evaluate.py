...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_root', default='/root/autodl-tmp/kitti/', 
                        help='your data root for kitti')
    parser.add_argument('--ckpt', default='None', help='your checkpoint for kitti')
    parser.add_argument('--saved_path', default='None', help='your saved path for predicted results')
